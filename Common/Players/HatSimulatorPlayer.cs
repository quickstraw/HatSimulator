...
using static HatSimulator.HatSimulator;
using static Terraria.ModLoader.ModContent;

namespace HatSimulator.Common.Players
{
    // ModPlayer classes provide a way to attach data to Players and act on that data. ExamplePlayer has a lot of functionality related to 
    // several effects and items in ExampleMod. See SimpleModPlayer for a very simple example of how ModPlayer classes work.
    public class HatSimulatorPlayer : ModPlayer
    {
        ...
        {
            HatSimulatorPlayer clone = targetCopy as HatSimulatorPlayer;
        ...
        public override void SyncPlayer(int toWho, int fromWho, bool newPlayer)
        {
            ...
            packet.Write((byte)HatSimulatorMessageType.HatSimulatorPlayerSyncPlayer);
        ...
        public override void SendClientChanges(ModPlayer clientPlayer)
        {
            ...
            HatSimulatorPlayer clone = clientPlayer as HatSimulatorPlayer;
