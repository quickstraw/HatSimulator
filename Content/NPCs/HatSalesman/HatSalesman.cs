using HatSimulator.Content.Items.LockBoxes;
...
namespace HatSimulator.Content.NPCs.HatSalesman
{
    [AutoloadHead]
    class HatSalesman : ModNPC
    {

        public override string Texture => "HatSimulator/Content/NPCs/HatSalesman/HatSalesman";
        ...
        {
            if (NPC.downedBoss2)  //after Eater of Worlds or Brain of Cthulu is killed
            {
                return true;
            }
            return false;
        ...
        {
            projType = ProjectileType<WrenchProjectile>();
            attackDelay = 1;
        }
