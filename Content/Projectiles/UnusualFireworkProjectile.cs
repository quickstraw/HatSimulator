...
using HatSimulator.Content.Sounds.Custom;

namespace HatSimulator.Content.Projectiles
{
    class UnusualFireworkProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            if (Projectile.ai[0] == 0)
            {
                ...
                SoundEngine.PlaySound(HatSimulatorSounds.UnusualOpenSound, Projectile.position);
            }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            SoundEngine.PlaySound(HatSimulatorSounds.UnusualPopVanilla, Projectile.position);
